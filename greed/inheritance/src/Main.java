                ...
                while( choice1 != "1") {
                    ...
                    switch (input2.nextLine()) {
                        case "1":
                            ...
                            var10000.println("It has " + var20 + " mirrors, \n" + bedroom.getNrOfChairs() + " chairs and " + bedroom.getNrOfClocks() + " clock. The time is " + bedroom.time + ".\n");
                            System.out.println("Nothing more to see here, let's go back to the hall.\n");
                            break;
                        case "2":
                            Bedroom2 bedroom2 = new Bedroom2();
                            System.out.println(bedroom2.getDescription());
                            var10000 = System.out;
                            var20 = bedroom2.getNrOfClocks();
                            var10000.println("It has " + var20 + " clock. The time is " + bedroom2.time + ".\n" + bedroom2.lookAtTheDressingTable());
                            Ghost ghost = new Ghost();
                            var10000 = System.out;
                            var10001 = ghost.getDescription();
                        ...
                        case "3":
                            ...
                            System.out.println(bedroom3.getDescription());
                            var10000 = System.out;
                            var20 = bedroom3.getNrOfClocks();
                            var10000.println("It has " + var20 + " clock. The time is " + bedroom3.time + ".\n");
                            System.out.println("Nothing more to see here, let's go back to the hall.\n");
                            break;
                        case "4":
